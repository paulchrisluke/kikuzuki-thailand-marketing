...
export async function getSiteLocalizationProgress(
  ...
  const groups = [
    ...
    { id: 'locations', label: 'Locations', result: progress(locations, ['title', 'address', 'city', 'neighborhood', 'description', 'short_description']), path: (row: LocalizableRow) => `locations/${row.location_slug}/settings/profile`, resourceType: 'business_location', resourceId: (row: LocalizableRow) => row.id },
    ...
    { id: 'blog', label: 'Blog', result: progress(blog, ['title', 'summary', 'metadata.category', 'metadata.tags', 'metadata.nav_title']), path: (row: LocalizableRow) => `blog/${row.id}`, resourceType: 'content_document', resourceId: (row: LocalizableRow) => row.id },
    { id: 'qa', label: 'Q&A', result: progress(qa, ['title', 'summary']), path: (row: LocalizableRow) => `locations/${row.location_slug}/qa`, resourceType: 'content_document', resourceId: (row: LocalizableRow) => row.id },
