...
/** The contract stores `HH:MM:SS`; the time control neither shows nor accepts seconds. */
...
/** An RFC 3339 instant as the local value a `datetime-local` control expects. */
...
/** The local value back as the RFC 3339 instant the contract requires. */
