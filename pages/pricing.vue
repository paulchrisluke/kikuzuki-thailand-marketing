      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div class="bg-(--ui-bg-inverted) text-white rounded-2xl shadow-lg p-8 transform scale-105">
            ...
            <p class="text-white/70 mb-6">For growing restaurants</p>
            <div class="mb-6">
              <span class="text-4xl font-bold">$25</span>
              <span class="text-white/70">/month</span>
            </div>
            <ul class="space-y-3 text-white/85 mb-8">
              <li class="flex items-start">
            ...
            <UButton color="neutral" size="xl" class="w-full bg-(--kc-coral) text-white hover:opacity-90">Start Pro Trial</UButton>
          </div>
