...
VALUES ('site-1', 'org-1', 'saya-theme-v1', 'Demo Restaurant', 'demo-restaurant', 'demo', 'active', 'active');

INSERT INTO site_domains (id, organization_id, site_id, domain, type, status)
VALUES ('dom-1', 'org-1', 'site-1', 'demo.localhost', 'subdomain', 'active');
...
-- Seed some content
INSERT INTO site_content (id, organization_id, site_id, page, field_key, value, type)
