...
export default defineNuxtConfig({
  app: {
    head: {
      ...
      link: [
        { rel: 'icon', href: 'https://sand-o-marketing.pages.dev/favicon.ico', type: 'image/x-icon' },
        { rel: 'shortcut icon', href: 'https://sand-o-marketing.pages.dev/favicon.ico', type: 'image/x-icon' }
      ]
    }
  },
